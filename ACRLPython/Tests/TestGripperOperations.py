...
class TestGripperOperations:
    ...
    def test_open_gripper_success(self, mock_broadcaster):
    ...
    def test_close_gripper_success(self, mock_broadcaster):
    ...
    def test_gripper_command_structure(self, mock_broadcaster):
...
class TestGripperErrors:
    ...
    def test_gripper_invalid_robot_id_empty(self, mock_broadcaster):
...
class TestGripperBroadcasting:
    ...
    def test_gripper_command_broadcast_open(self, mock_broadcaster):
    ...
    def test_gripper_command_broadcast_close(self, mock_broadcaster):
...
class TestGripperOperationDefinition:
    ...
    def test_operation_definition_exists(self):
        ...
        assert CONTROL_GRIPPER_OPERATION.operation_id == "manipulation_control_gripper_001"
