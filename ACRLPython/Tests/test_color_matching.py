...
def test_color_matches():
    ...
    assert color_matches("green_cube", "green"), "Partial match failed: green in green_cube"

    # Test case insensitive
    assert color_matches("Blue_Cube", "blue"), "Case insensitive failed: blue matches Blue_Cube"
    assert color_matches("RED_CUBE", "red"), "Case insensitive failed: red matches RED_CUBE"
