...
YOLO_MODEL_PATH = os.environ.get(
    "YOLO_MODEL_PATH",
    str(_CONFIG_DIR / "yolo" / "models" / "field_detector.onnx")
)
...
SAVE_DEBUG_POINT_CLOUDS = os.environ.get("SAVE_DEBUG_POINT_CLOUDS", "false").lower() in ("true", "1", "yes")
...
ENABLE_STEREO_VALIDATION = os.environ.get("ENABLE_STEREO_VALIDATION", "false").lower() in ("true", "1", "yes")
...
ENABLE_OBJECT_TRACKING = os.environ.get("ENABLE_OBJECT_TRACKING", "true").lower() in ("true", "1", "yes")
...
YOLO_INPUT_SIZE = None  # Downscale for speed (None = original)
