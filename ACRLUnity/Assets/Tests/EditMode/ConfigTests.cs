...
namespace Tests.EditMode
{
    ...
    public class ConfigTests
    {
        ...
        public void RobotConfig_DefaultCreation_CreatesValidProfile()
        {
            ...
            Assert.AreEqual(
                "AR4_Default",
                _robotConfig.profileName,
                "Profile name should be AR4_Default"
            );
        ...
        public void RobotConfig_AdjustmentSpeed_IsInValidRange()
        {
            Assert.GreaterOrEqual(
                _robotConfig.adjustmentSpeed,
                0.1f,
                "Adjustment speed should be >= 0.1"
            );
            Assert.LessOrEqual(
                _robotConfig.adjustmentSpeed,
                1f,
                "Adjustment speed should be <= 1.0"
            );
        }
        ...
        public void RobotConfig_OnValidate_ClampsAdjustmentSpeed()
        {
            ...
            var onValidateMethod = typeof(RobotConfig).GetMethod(
                "OnValidate",
        ...
        public void RobotConfig_OnValidate_FixesInvalidJointLimits()
        {
            ...
            Assert.Greater(
                _robotConfig.joints[0].upperLimit,
                _robotConfig.joints[0].lowerLimit,
        ...
        public void SimulationConfig_DefaultCreation_HasValidDefaults()
        {
            ...
            Assert.AreEqual(
                false,
                _simulationConfig.autoStart,
                "Auto-start should be false by default"
            );
            Assert.AreEqual(
                true,
                _simulationConfig.resetOnError,
                "Reset on error should be true by default"
            );
        }
        ...
        {
            Assert.GreaterOrEqual(
                _simulationConfig.targetFrameRate,
                10,
                "Target frame rate should be >= 10"
            );
            Assert.LessOrEqual(
                _simulationConfig.targetFrameRate,
                120,
                "Target frame rate should be <= 120"
            );
        }
        ...
        {
            var onValidateMethod = typeof(SimulationConfig).GetMethod(
                "OnValidate",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance
            );
            ...
            Assert.GreaterOrEqual(
                _simulationConfig.timeScale,
                0.1f,
                "Time scale should be clamped to minimum 0.1"
            );
        }
        ...
        public void SimulationConfig_OnValidate_ClampsTargetFrameRate()
        {
            ...
            Assert.GreaterOrEqual(
                _simulationConfig.targetFrameRate,
                10,
                "Should clamp to minimum 10 FPS"
            );
            ...
            Assert.LessOrEqual(
                _simulationConfig.targetFrameRate,
                120,
                "Should clamp to maximum 120 FPS"
            );
        }
        ...
        public void IKConfig_DefaultCreation_HasValidDefaults()
        {
            ...
            Assert.AreEqual(
                0.02f,
                _ikConfig.convergenceThreshold,
                0.001f,
                "Default convergence threshold should be 0.02m (2cm)"
            );
            Assert.AreEqual(
                0.2f,
                _ikConfig.dampingFactor,
                0.01f,
                "Default damping factor should be 0.2"
            );
            Assert.AreEqual(
                0.2f,
                _ikConfig.maxJointStepRad,
                0.01f,
                "Default max joint step should be 0.2 rad"
            );

            // Orientation control defaults
            Assert.AreEqual(
                10f,
                _ikConfig.orientationThresholdDegrees,
                0.1f,
                "Default orientation threshold should be 10 degrees"
            );
            Assert.AreEqual(
                0.30f,
                _ikConfig.orientationRampStartDistance,
                0.01f,
                "Default orientation ramp start should be 0.30m"
            );

            // Timeout defaults
            Assert.AreEqual(
                30f,
                _ikConfig.graspTimeoutSeconds,
                0.1f,
                "Default grasp timeout should be 30s"
            );
            Assert.AreEqual(
                15f,
                _ikConfig.movementTimeoutSeconds,
                0.1f,
                "Default movement timeout should be 15s"
            );
        }
        ...
        public void IKConfig_MotionLimits_AreValid()
        {
            ...
            Assert.GreaterOrEqual(
                _ikConfig.maxAcceleration,
                0.3f,
                "Max acceleration should be >= 0.3"
            );
        ...
        {
            Assert.GreaterOrEqual(
                _ikConfig.graspConvergenceMultiplier,
                0.1f,
                "Grasp convergence multiplier should be >= 0.1"
            );
            Assert.LessOrEqual(
                _ikConfig.graspConvergenceMultiplier,
                1f,
                "Grasp convergence multiplier should be <= 1.0"
            );
            Assert.GreaterOrEqual(
                _ikConfig.preGraspConvergenceMultiplier,
                1f,
                "Pre-grasp convergence multiplier should be >= 1.0"
            );
            Assert.LessOrEqual(
                _ikConfig.preGraspConvergenceMultiplier,
                5f,
                "Pre-grasp convergence multiplier should be <= 5.0"
            );
        }
        ...
        {
            Assert.GreaterOrEqual(
                _ikConfig.maxJointVelocity,
                1f,
                "Max joint velocity should be >= 1.0"
            );
            Assert.LessOrEqual(
                _ikConfig.maxJointVelocity,
                10f,
                "Max joint velocity should be <= 10.0"
            );
            Assert.GreaterOrEqual(
                _ikConfig.maxErrorMagnitude,
                0.1f,
                "Max error magnitude should be >= 0.1"
            );
            Assert.LessOrEqual(
                _ikConfig.maxErrorMagnitude,
                5f,
                "Max error magnitude should be <= 5.0"
            );
        }
        ...
        {
            Assert.GreaterOrEqual(
                _ikConfig.objectFindingRadius,
                0.05f,
                "Object finding radius should be >= 0.05"
            );
            Assert.LessOrEqual(
                _ikConfig.objectFindingRadius,
                0.5f,
                "Object finding radius should be <= 0.5"
            );
            Assert.GreaterOrEqual(
                _ikConfig.objectDistanceThreshold,
                0.05f,
                "Object distance threshold should be >= 0.05"
            );
            Assert.LessOrEqual(
                _ikConfig.objectDistanceThreshold,
                0.3f,
                "Object distance threshold should be <= 0.3"
            );
        }
        ...
        {
            var onValidateMethod = typeof(IKConfig).GetMethod(
                "OnValidate",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance
            );
        ...
        public void GripperConfig_DefaultCreation_HasValidDefaults()
        {
            ...
            Assert.AreEqual(
                5,
                _gripperConfig.forceWindowSize,
                "Default force window size should be 5"
            );
            Assert.AreEqual(
                0.1f,
                _gripperConfig.minForceThreshold,
                0.01f,
                "Default min force threshold should be 0.1N"
            );
            Assert.AreEqual(
                0.1f,
                _gripperConfig.minContactDuration,
                0.01f,
                "Default min contact duration should be 0.1s"
            );
            Assert.AreEqual(
                5f,
                _gripperConfig.minGraspForce,
                0.1f,
                "Default min grasp force should be 5N"
            );

            // Gripper control defaults
            Assert.AreEqual(
                0.5f,
                _gripperConfig.smoothTime,
                0.01f,
                "Default smooth time should be 0.5s"
            );
        }
        ...
        public void GripperConfig_ForceParameters_AreValid()
        {
            Assert.GreaterOrEqual(
                _gripperConfig.forceWindowSize,
                3,
                "Force window size should be >= 3"
            );
            Assert.LessOrEqual(
                _gripperConfig.forceWindowSize,
                10,
                "Force window size should be <= 10"
            );
            Assert.GreaterOrEqual(
                _gripperConfig.minForceThreshold,
                0.01f,
                "Min force threshold should be >= 0.01"
            );
            Assert.LessOrEqual(
                _gripperConfig.minForceThreshold,
                1f,
                "Min force threshold should be <= 1.0"
            );
            Assert.GreaterOrEqual(
                _gripperConfig.minGraspForce,
                1f,
                "Min grasp force should be >= 1.0"
            );
            Assert.LessOrEqual(
                _gripperConfig.minGraspForce,
                20f,
                "Min grasp force should be <= 20.0"
            );
        }
        ...
        {
            var onValidateMethod = typeof(GripperConfig).GetMethod(
                "OnValidate",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance
            );
        ...
        public void TrajectoryConfig_DefaultCreation_HasValidDefaults()
        {
            ...
            Assert.AreEqual(
                10f,
                _trajectoryConfig.positionGains.x,
                0.1f,
                "Default position gain X should be 10"
            );
            Assert.AreEqual(
                10f,
                _trajectoryConfig.positionGains.y,
                0.1f,
                "Default position gain Y should be 10"
            );
            Assert.AreEqual(
                10f,
                _trajectoryConfig.positionGains.z,
                0.1f,
                "Default position gain Z should be 10"
            );

            // Velocity gains (default to 2, 2, 2)
            Assert.AreEqual(
                2f,
                _trajectoryConfig.velocityGains.x,
                0.1f,
                "Default velocity gain X should be 2"
            );
            Assert.AreEqual(
                2f,
                _trajectoryConfig.velocityGains.y,
                0.1f,
                "Default velocity gain Y should be 2"
            );
            Assert.AreEqual(
                2f,
                _trajectoryConfig.velocityGains.z,
                0.1f,
                "Default velocity gain Z should be 2"
            );

            // Motion limits
            Assert.AreEqual(
                0.5f,
                _trajectoryConfig.maxVelocity,
                0.01f,
                "Default max velocity should be 0.5 m/s"
            );
            Assert.AreEqual(
                1.0f,
                _trajectoryConfig.maxAcceleration,
                0.01f,
                "Default max acceleration should be 1.0 m/s²"
            );
        }
        ...
        public void TrajectoryConfig_PDGains_ArePositive()
        {
            Assert.Greater(
                _trajectoryConfig.positionGains.x,
                0f,
                "Position gain X should be positive"
            );
            Assert.Greater(
                _trajectoryConfig.positionGains.y,
                0f,
                "Position gain Y should be positive"
            );
            Assert.Greater(
                _trajectoryConfig.positionGains.z,
                0f,
                "Position gain Z should be positive"
            );
            Assert.Greater(
                _trajectoryConfig.velocityGains.x,
                0f,
                "Velocity gain X should be positive"
            );
            Assert.Greater(
                _trajectoryConfig.velocityGains.y,
                0f,
                "Velocity gain Y should be positive"
            );
            Assert.Greater(
                _trajectoryConfig.velocityGains.z,
                0f,
                "Velocity gain Z should be positive"
            );
        }
        ...
        public void TrajectoryConfig_MotionLimits_AreValid()
        {
            ...
            Assert.LessOrEqual(
                _trajectoryConfig.maxAcceleration,
                2f,
                "Max acceleration should be <= 2.0"
            );
        }
        ...
        {
            var onValidateMethod = typeof(TrajectoryConfig).GetMethod(
                "OnValidate",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance
            );
            ...
            Assert.GreaterOrEqual(
                _trajectoryConfig.positionGains.x,
                0.1f,
                "Position gain X should be clamped to >= 0.1"
            );
            Assert.GreaterOrEqual(
                _trajectoryConfig.positionGains.y,
                0.1f,
                "Position gain Y should be clamped to >= 0.1"
            );
            Assert.GreaterOrEqual(
                _trajectoryConfig.positionGains.z,
                0.1f,
                "Position gain Z should be clamped to >= 0.1"
            );
            Assert.GreaterOrEqual(
                _trajectoryConfig.velocityGains.x,
                0.1f,
                "Velocity gain X should be clamped to >= 0.1"
            );
            Assert.GreaterOrEqual(
                _trajectoryConfig.velocityGains.y,
                0.1f,
                "Velocity gain Y should be clamped to >= 0.1"
            );
            Assert.GreaterOrEqual(
                _trajectoryConfig.velocityGains.z,
                0.1f,
                "Velocity gain Z should be clamped to >= 0.1"
            );
        }
        ...
        public void IKConfig_GraspConvergenceThreshold_CalculatesCorrectly()
        {
            ...
            float expectedThreshold =
                config.convergenceThreshold * config.graspConvergenceMultiplier;
            ...
            Assert.AreEqual(
                ...
                0.001f,
                "Default convergence threshold should be 0.02m"
            );
            Assert.AreEqual(
                0.33f,
                config.graspConvergenceMultiplier,
                0.01f,
                "Default grasp multiplier should be 0.33"
            );
            Assert.AreEqual(
                0.0066f,
                expectedThreshold,
        ...
        public void IKConfig_OrientationThreshold_DefaultIs10Degrees()
        {
            ...
            Assert.AreEqual(
                10f,
                config.orientationThresholdDegrees,
                0.1f,
        ...
        public void IKConfig_OrientationRampStart_DefaultIs30cm()
        {
            ...
            Assert.AreEqual(
                0.30f,
                config.orientationRampStartDistance,
                0.01f,
        ...
        public void IKConfig_PreGraspConvergenceMultiplier_DefaultIs2x()
        {
            ...
            Assert.AreEqual(
                2.0f,
                config.preGraspConvergenceMultiplier,
                0.1f,
