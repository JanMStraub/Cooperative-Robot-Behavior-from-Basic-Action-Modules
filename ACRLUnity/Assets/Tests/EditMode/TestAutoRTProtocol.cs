...
namespace Tests.EditMode
{
    ...
    public class TestAutoRTProtocol
    {
        ...
        public void TestAutoRTCommand_Generate_EncodeDecode()
        {
            ...
            string paramsJson =
                "{\"num_tasks\":5,\"robot_ids\":[\"Robot1\",\"Robot2\"],\"strategy\":\"balanced\"}";
            ...
            Assert.Greater(
                ...
                "Encoded message should be larger than header"
            );
            Assert.AreEqual(
                (byte)MessageType.AUTORT_COMMAND,
                encoded[0],
                "Message type should be AUTORT_COMMAND"
            );

            // Act - Decode
            UnityProtocol.DecodeAutoRTCommand(
                encoded,
                out uint decodedRequestId,
                out string decodedCommand,
                out string decodedParams
            );
        ...
        public void TestAutoRTCommand_StartLoop_EncodeDecode()
        {
            ...
            string paramsJson =
                "{\"loop_delay\":5.0,\"robot_ids\":[\"Robot1\"],\"strategy\":\"explore\"}";
        ...
        public void TestAutoRTResponse_Success_EncodeDecode()
        {
            ...
            Assert.AreEqual(
                (byte)MessageType.AUTORT_RESPONSE,
                encoded[0],
                "Message type should be AUTORT_RESPONSE"
            );
        ...
        {
            AutoRTResponse response = new AutoRTResponse { success = true, error = null };
        ...
        public void TestAutoRTResponse_ErrorMessage()
        {
            ...
            AutoRTResponse successResponse = new AutoRTResponse { success = true, error = null };
        ...
        public void TestProposedTask_JsonSerialization()
        {
            ProposedTask task = new ProposedTask
            {
                ...
                operations = new List<TaskOperation>
                {
                    new TaskOperation { type = "move", robot_id = "Robot1" },
                },
                required_robots = new List<string> { "Robot1" },
                estimated_complexity = 2,
                reasoning = "Test",
        ...
        public void TestAutoRTCommand_LargeParams()
        {
            ...
            string largeParams =
                $"{{\"robot_ids\":[{string.Join(",", manyRobots.ConvertAll(r => $"\"{r}\""))}]}}";
        ...
        public void TestAutoRTResponse_MultipleTasks()
        {
            ...
            AutoRTResponse response = new AutoRTResponse { success = true, loop_running = false };
