...
namespace Tests.PlayMode
{
    ...
    public class GraspIKFilterTests
    {
        ...
        public void FilterCandidates_WithinReach_AcceptedWhenValidationDisabled()
        {
            ...
            Assert.IsTrue(
                validCandidates[0].ikValidated,
                "Should be marked as validated when IK validation disabled"
            );
            Assert.AreEqual(
                1.0f,
                validCandidates[0].ikScore,
                EPSILON,
                "Should have perfect IK score when validation disabled"
            );
        }
        ...
        public void FilterCandidates_ExactlyAtReach_Accepted()
        {
            ...
            Assert.AreEqual(
                ...
                "Candidate exactly at max reach should be accepted"
            );
        }
        ...
        public IEnumerator FilterCandidates_IKValidationEnabled_SetsValidationFlags()
        {
            ...
            foreach (var candidate in validCandidates)
            {
                Assert.IsTrue(
                    ...
                    "Returned candidates should have ikValidated=true"
                );
            }
        }
        ...
        public void FilterCandidates_ValidationDisabled_SkipsIKComputation()
        {
            ...
            Assert.IsTrue(
                validCandidates[0].ikValidated,
                "Should be marked validated even though IK was skipped"
            );
            Assert.AreEqual(
                1.0f,
                validCandidates[0].ikScore,
                EPSILON,
                "Should have perfect score when validation skipped"
            );
        }
        ...
        public void FilterCandidates_LargeBatch_ProcessesAll()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                candidates.Add(
                    CreateTestCandidate(new Vector3(x, 0.2f, 0.2f), new Vector3(x, 0.1f, 0.2f))
                );
            }
            ...
            Assert.AreEqual(
                20,
                validCandidates.Count,
                "Should process all candidates in large batch"
            );
        }
        ...
        public void FilterCandidates_IdenticalCandidates_ProcessesAll()
        {
            ...
            Assert.AreEqual(
                3,
                validCandidates.Count,
                "Should process all identical candidates independently"
            );
        }
        ...
        public void FilterCandidates_100Candidates_CompletesInReasonableTime()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                float y = (i / 10) * 0.05f;
                candidates.Add(
                    CreateTestCandidate(new Vector3(x, y, 0.2f), new Vector3(x, y, 0.1f))
                );
            }
